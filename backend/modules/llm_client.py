...
# def summarize(prompt: str, max_tokens: int = 300) -> str:
#     """
#     Send a single-turn user prompt to the LLM and return its string reply.
#     """
#     # build the usual chat‐style messages
#     messages = [
#         {
#             "role": "user",
...
#     # resp may be a ModelResponse; extract a plain string
#     # try common attributes, else fallback to str()
